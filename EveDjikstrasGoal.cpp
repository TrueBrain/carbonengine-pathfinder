...
// -------------------------------------------------------------
// Description:
//   Checks if a system is the goal.
// Arguments:
...
// -------------------------------------------------------------
bool EveDjikstrasGoal::IsGoal( const EveMap& universe, EveMapNodeID nodeID ) const
{
	return m_goal == nodeID;
}
...
//   The cost (1.0f)
// -------------------------------------------------------------
float EveDjikstrasGoal::GetTraversalCost( const EveMapNode& from, const EveMapNode& to ) const
{
	return 1.0f;
}
...
// -------------------------------------------------------------
float EveDjikstrasGoal::GetHeuristicEstimate( const EveMapNode& node ) const
{
	return 0.0f;
}
...
// -------------------------------------------------------------
void EveDjikstrasGoal::GetNeighbours( const EveMap& universe, EveMapNodeID node, std::vector<EveMapNodeID>& neighbours ) const
{
	neighbours.clear();
...
// -------------------------------------------------------------
// Description:
//   Set a goal system that, when found, will cause path-finding to end
// Arguments:
//   universe - the map
//   goal - the system that will cause termination of path-finding
// -------------------------------------------------------------
void EveDjikstrasGoal::SetGoal( const EveMap& universe, EveMapNodeID goal )
{
	m_goal = goal;
}
...
// -------------------------------------------------------------
void EveDjikstrasGoal::GetOriginSystems( std::vector<EveMapNodeID>& outOriginSystems ) const
{
...
// -------------------------------------------------------------
void EveDjikstrasGoal::AddOrigin( EveMapNodeID origin )
{
...
// -------------------------------------------------------------
void EveDjikstrasGoal::ClearOrigins()
{

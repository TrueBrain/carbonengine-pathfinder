...
class ServerPathfinderTestCase(unittest.TestCase):
    ...
    @mock.patch("evePathfinder.restricted.pathfinder.IsWormholeSystem")
    ...
    @mock.patch("evePathfinder.restricted.pathfinder.IsWormholeSystem")
    def testGetPathBetweenForRouteType(self, isWormholeSystem):
        isWormholeSystem.side_effect = [False, False]
    ...
    @mock.patch("evePathfinder.restricted.pathfinder.IsWormholeSystem")
    def testGetPathBetweenForRouteTypeToWormholeSpace(self, isWormholeSystem):
        isWormholeSystem.side_effect = [False, True]

...
class EvePathfinderCore(object):
    ...
    def _RunNewPathfinderFrom(self, solarSystemID, cache, routeType, penalty, minSec, maxSec, avoidanceSystems, goalSystems):
        ...
        # Goal systems allow us to circumvent the avoidance
        ...
        pyEvePathfinder.FindRoute(
            ...
            self.newPathfinderGoal,
            cache.GetCacheForPathfinding()
        )
    ...
    def RefreshCache(self, pathfindingCache, stateInterface, startingSolarSystemID, goalSystems):
        ...
        self._RunNewPathfinderFrom(
            startingSolarSystemID,
            pathfindingCache,
            routeType,
            stateInterface.GetSecurityPenalty(),
            secInterval.minSecurity,
            secInterval.maxSecurity,
            avoidedSystems,
            goalSystems
        )
        pathfindingCache.MarkAsClean()

        # If we find a path to an avoided system, we need to invalidate the results
